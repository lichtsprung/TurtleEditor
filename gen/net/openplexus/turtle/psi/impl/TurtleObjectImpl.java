...
public class TurtleObjectImpl extends ASTWrapperPsiElement implements TurtleObject {

  public TurtleObjectImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public TurtleLiteral getLiteral() {
    return findChildByClass(TurtleLiteral.class);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof TurtleVisitor) ((TurtleVisitor)visitor).visitObject(this);
